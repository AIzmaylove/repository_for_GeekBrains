...
class BinaryTree:
    ...
    def insert_left(self, new_node):
        try:
            if new_node >= self.root:
                raise MyExeption(f'Ошибка! Левый потомок = {new_node} больше корня = {self.root}!')
    ...
    def insert_right(self, new_node):
        try:
            if new_node <= self.root:
                raise MyExeption(f'Ошибка! Правый потомок = {new_node} меньше корня = {self.root}!')
        except MyExeption as err:
            print(err)
        else:
    ...
    def get_right_child(self):
        try:
            if self.right_child is None:
                raise MyExeption('Потомка справа не существует!')
    ...
    def get_left_child(self):
        try:
            if self.left_child is None:
                raise MyExeption('Потомка слева не существует!')
    ...
    def set_root_val(self, obj):
        try:
            ...
            or self.get_right_child.get_root_val and self.get_right_child.get_root_val < obj:
                raise MyExeption('Неверное значение!')
            self.root = obj
        except MyExeption as err:
            print(err)
